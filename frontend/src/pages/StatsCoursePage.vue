...
const columns = [
  ...
  { name: 'participants', label: 'Participants', field: 'participantCount', align: 'center', sortable: true },
  { name: 'questions', label: 'Questions', field: 'questionCount', align: 'center', sortable: true },
  { name: 'avgScore', label: 'Avg. Score', field: 'averageScore', align: 'center', sortable: true, 
